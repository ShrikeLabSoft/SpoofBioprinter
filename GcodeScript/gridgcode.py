...
G1 X""" + ( '%.3f' % (distance/2) )+""" Y-2.500
G1 X""" + ( '%.3f' % (distance/2) )+""" Y2.500 E1 
G1 X""" + ( '%.3f' % (distance/-2) )+""" Y-2.500
G1 X""" + ( '%.3f' % (distance/-2) )+""" Y2.500 E2   
""")

print("""
G1 Z0.200 F300.00
G1 X-2.500 Y""" + ( '%.3f' % (distance/2) )+""" 
G1 X2.500 Y""" + ( '%.3f' % (distance/2) )+"""  E3
G1 X-2.500 Y""" + ( '%.3f' % (distance/-2) )+""" 
G1 X2.500 Y""" + ( '%.3f' % (distance/-2) )+"""  E4
""")
